...
locals {
    ...
    availability_options = {
        ...
        zone = "${module.default.region_code[local.regional_options.name]}-b" # Example: ["asia-east2-b"]
    }
    general_options = {
    ...
    subnet_ip_cidr_range = {
        hongkong = {
            primary = "172.16.3.0/24" # [Primary] Private Subnet IP Range.
            secondary = ["192.168.3.0/24"] # [Secondary] Private Subnet IP Range.
        }
        singapore = {
            primary = "172.18.3.0/24" # [Primary] Private Subnet IP Range.
            secondary = ["10.18.3.0/24"] # [Secondary] Private Subnet IP Range.
        }
    }
    gce_options = {
...
module "workers" {
    ...
    zone = "asia-east2-b" # [Optional] ["asia-east2-b"] HongKong [Zone::B].
    subnet_range = local.subnet_ip_cidr_range.hongkong.primary
