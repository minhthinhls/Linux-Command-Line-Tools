...
locals {
    ...
    availability_options = {
        ...
        zone = "${module.default.region_code[local.regional_options.name]}-c" # Example: ["asia-east2-c"]
    }
    general_options = {
    ...
    subnet_ip_cidr_range = {
        hongkong = {
            primary = "172.16.4.0/24" # [Primary] Private Subnet IP Range.
            secondary = ["192.168.4.0/24"] # [Secondary] Private Subnet IP Range.
        }
        singapore = {
            primary = "172.18.4.0/24" # [Primary] Private Subnet IP Range.
            secondary = ["10.18.4.0/24"] # [Secondary] Private Subnet IP Range.
        }
    }
    gce_options = {
...
module "workers" {
    ...
    zone = "asia-east2-c" # [Optional] ["asia-east2-c"] HongKong [Zone::C].
    subnet_range = local.subnet_ip_cidr_range.hongkong.primary
